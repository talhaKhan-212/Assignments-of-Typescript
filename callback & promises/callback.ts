...
function carMaintCallBack(text:string){   // callBack
...
function dressCallBack(text:string){          // Callback
 ...
 function eventCallBack(text:string){     // Callback
    console.log(text);
    BacktoHome();
 };
 function BacktoHome(){
...
function teamwork(cb:(Text:string)=>void){
...
function teamworkCallBack(text:string){
    console.log("All work is officially done by company...", text)
    visitor(buses);
}

function visitor(cb:(Text:string)=>void){
console.log("My team decide to vist Ratti Gali");
cb("program is done");
}

function buses(text:string){
    console.log("We reached back at home at 9 o'clock...",text)
}

teamwork(function(text:string){
    console.log("All work is officially done by company...", text)
    visitor(function(text:string){
        console.log("We reached back at home at 9 o'clock...", text)
    })
})